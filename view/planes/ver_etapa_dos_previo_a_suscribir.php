...
<div class="row">
    <div class="col-md-12">
        <h2 align="Center">Plan de mejoramiento - Etapa retroalimentacion auditado - Previo a suscribir plan</h2>
        <hr>
    </div>
</div>
            ...
            <tbody>
                ...
                <?php foreach ($listadoObservaciones as $r) { ?>
                    <tr>
                        ...
                        <td><?php echo $r->reaccion; ?></td>
                        <td><?php echo $r->causa; ?></td>
                        <td><?php echo $r->nc_similar; ?></td>
                        <td><?php echo $r->accion_mejoramiento; ?></td>
                        <td><?php echo $r->plazo; ?></td>
